...
RSpec.describe MetalArchives::Artist do
  ...
  describe "serialization" do
    it "serializes" do
      ...
      expect(artist.to_h)
        .to include type: "artist",
                    id: 60_908,
                    name: "Alberto Rionda",
                    aliases: [],
                    country: "ESP",
                    location: "Oviedo, Asturias",
                    date_of_birth: "1972-09-02",
                    date_of_death: nil,
                    cause_of_death: nil,
                    gender: :male,
                    biography: /Avalanch/,
                    trivia: /Sanctuarium Estudios/,
                    links: include(title: "Facebook", type: :official, url: "https://www.facebook.com/albertoriondaoficial"),
                    photo: %r(/images/6/0/9/0/60908_artist.jpg),
                    bands: include(id: 3_540_361_100, years_active: 2013.., role: "Guitars", active: true)
    end

    it "deserializes" do
      artist = described_class.from_h type: "artist",
                                      id: 60_908,
                                      name: "Alberto Rionda",
                                      aliases: [],
                                      country: "ESP",
                                      ...
                                      biography: "Avalanch",
                                      trivia: "Sanctuarium Estudios",
                                      links: [{ title: "Facebook", type: "official", url: "https://www.facebook.com/albertoriondaoficial" }],
                                      photo: "https://www.metal-archives.com/images/6/0/9/0/60908_artist.jpg",
                                      bands: [{ id: 3_540_361_100, years_active: "2013..", role: "Guitars", active: true }]
      ...
      expect(artist.location).to eq "Oviedo, Asturias"
      expect(artist.date_of_birth).to eq Date.new(1972, 9, 2)
      expect(artist.date_of_death).to be_blank
      expect(artist.cause_of_death).to be_blank
      expect(artist.gender).to eq :male
      expect(artist.biography).to include "Avalanch"
      expect(artist.trivia).to match "Sanctuarium Estudios"
      expect(artist.links).to include title: "Facebook", type: :official, url: "https://www.facebook.com/albertoriondaoficial"
      expect(artist.photo).to include "/images/6/0/9/0/60908_artist.jpg"
      expect(artist.bands).to include id: 3_540_361_100, years_active: 2013.., role: "Guitars", active: true
    end
  end
end
