...
RSpec.describe MetalArchives::NilDate do
  ...
  it "includes comparable" do
    date1 = described_class.new 2015, 0o1, 0o1
    date2 = described_class.new 2015, 0o1, 0o2
    date3 = described_class.new 2015, 0o2, 0o1
    date4 = described_class.new 2016, 0o1, 0o2
    date5 = described_class.new 2015, 0o1, 0o1
    date6 = described_class.new 2014, 12, 31
    date7 = described_class.new 2015, 0o1, nil
    date8 = described_class.new 2015, 0o1, nil
    date9 = described_class.new 2015, 0o2, nil
